...
class TTNetworkCoreDataManager {
    ...
    // MARK:- Configuration
    static let modelName = "CityPost"
    static let storeName = "CityPost.sqlite"
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: TTNetworkCoreDataManager.modelName, withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.appendingPathComponent(TTNetworkCoreDataManager.storeName)
        var failureReason = "There was an error creating or loading the application's saved data."
        do {
            try coordinator.addPersistentStore(ofType: NSSQLiteStoreType, configurationName: nil, at: url, options: TTNetworkCoreDataManager.storeOption)
        } catch {
            ...
            let wrappedError = NSError(domain: TTNetworkCoreDataManager.modelName, code: 9999, userInfo: dict)
